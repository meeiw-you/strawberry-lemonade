...
or if you want to come to my server , https://discord.gg/ysFzG4987s.""")
    ...
    if message.content.startswith(pre + "pg"):
        await message.author.send("password: "+ password)
...
client.run("MTA0MTMzODgxOTIwMDQyMTg4OA.G3v2cK.hv7luWtH8a-LmNO6ffmawaitdACGoCAHxJ22Mw")#,log_handler=handler, log_level=logging.DEBUG)
